          ...
          <div className="animate-fade-in">
            ...
            <div className="bg-white/50 backdrop-blur-sm border border-stone-100 rounded-2xl p-6 mb-8">
              ...
              <p className="font-serif italic text-earth/70 text-base leading-relaxed">
                {passed
                  ? '"You carry the song of the sparrow in your heart. The flock is stronger with you."'
                  : '"Every great guardian starts by listening. Your commitment marks the beginning."'}
              </p>
            </div>
